...
void main()
{
	...
	if(u_type==1.0)  // Directional light, check if in field of view and get the depth
	{
	...
	else if(u_type==2.0)  // Point light, just get the depth given light vector
	{
	...
	{
		intensity = 1.0;//0.5*(1.0-lenToLight);
	}
